...
Server.prototype.setupServer = function(config){
    ...
    this.username = config.username || def.username; //Configuring the username for the telos server
    this.password = config.password || def.password; //Configuring the password for the telos server
